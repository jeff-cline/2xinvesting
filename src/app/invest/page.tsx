...
export default async function InvestPage({ searchParams }: { searchParams: Promise<{ offer?: string }> }) {
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="wrap"><div className="form-wrap"><IntakeForm offer={offer} /></div></div>
      </main>
      <Footer />
    </>
  );
