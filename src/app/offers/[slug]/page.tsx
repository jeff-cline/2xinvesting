    ...
    <>
      ...
      <main>
        <div className="wrap page-head">
          ...
          <div className="detail-hero fade d1" style={offer.featuredImage ? { backgroundImage: `url(${offer.featuredImage})`, backgroundSize: "cover", backgroundPosition: "center" } : { background: "linear-gradient(150deg,#153a2c,#0c1d16 55%,#1a140b)" }}>
