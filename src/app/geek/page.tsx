    ...
    <>
      ...
      <main>
        <div className="wrap page-head" style={{ textAlign: "center" }}>
          ...
          <p className="lede" style={{ margin: "16px auto 0", maxWidth: "52ch", color: "var(--muted)" }}>Every industry is a <em style={{ color: "var(--gold-soft)", fontStyle: "italic" }}>byway</em> from being Uberized. If you want in early, tell us what you&rsquo;re building — Jeff Cline will reach out.</p>
        </div>
